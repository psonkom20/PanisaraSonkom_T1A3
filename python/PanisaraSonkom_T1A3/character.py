...
charDict6 = {
   'Name' : 'Bran Stark',
   'Quote': "An endless night. He wants to erase this world, and I am its memory.",
   'Hint' : "This character can see the future, the past, and distant events.",   
}
charDict7 = {
...
charDict11 = {
   ...
   'Hint' : "For many, this character symbolizes redemption or… that people can change after hacing a limb chopped off.",
}
charDict12 = {
...
#combine ditionary together so all characters can be selected
charList = [charDict1, charDict2, charDict3, charDict4, charDict5, charDict6, charDict7, charDict8, charDict9, charDict10, charDict11, charDict12, charDict13, charDict14, charDict15]
